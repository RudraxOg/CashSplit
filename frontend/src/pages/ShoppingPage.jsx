...
export default function ShoppingPage({ items, onToggle, onPurchase, onDelete, onEdit, onAdd, openAdd }) {
  return (
    <div className="rm-animate-in max-w-2xl">
      ...
      <ShoppingList items={items} onToggle={onToggle} onPurchase={onPurchase} onDelete={onDelete} onEdit={onEdit} onAdd={onAdd} compact={false} setPage={() => {}} />
    </div>
  );
}
